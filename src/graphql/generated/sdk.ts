...
export type GetBuildsQuery = { organization?: { pipelines?: { edges?: Array<{ node?: { slug: string, name: string, builds?: { edges?: Array<{ node?: { id: string, number: number, url: string, state: BuildStates, message?: string | null, commit: string, branch: string, createdAt?: string | null, startedAt?: string | null, finishedAt?: string | null, source: { name: string } | { name: string } | { name: string } | { name: string } | { name: string }, createdBy?: { __typename: 'UnregisteredUser', name?: string | null, email?: string | null } | { __typename: 'User', name: string, email: string } | null } | null } | null> | null, pageInfo?: { hasNextPage: boolean, endCursor?: string | null } | null } | null } | null } | null> | null } | null } | null };
